...
<body>
    <!-- <section class="banner-section">
        ...
        <p>Kami Siap Melayani Kesehatan Anda dengan sepenuh Hati</p>
    </section> -->
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    ...
                    <h4 class="m-0 text-center">Silahkan Untuk dapat Mendaftar Poliklinik</h4>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div style="background-image: url('assets/images/bannerpasien.png'); background-size: cover; height: 400px; position: relative;">
                <marquee style="position: absolute; bottom: 0; background-color: rgba(0,0,0,0.5); color: white; width: 100%; padding: 10px;">
                "Percayakan kesehatan Anda pada ahlinya! - Rutinlah memeriksakan diri ke dokter untuk menjaga kesehatan tubuh Anda - Deteksi dini masalah kesehatan dan nikmati hidup yang lebih berkualitas."
                </marquee>
            </div>
