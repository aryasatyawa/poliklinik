...
<section class="content mt-5">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div style="background-image: url('assets/images/bannerdokter.png'); background-size: cover; height: 400px; position: relative;">
                <marquee style="position: absolute; bottom: 0; background-color: rgba(0,0,0,0.5); color: white; width: 100%; padding: 10px;">
                "Teruslah menjadi harapan bagi banyak orang! - Dedikasimu menyelamatkan dan merawat pasien adalah inspirasi - Tetaplah semangat, karena setiap usaha kecilmu membawa perubahan besar bagi kehidupan mereka."
                </div>
            </div>
        </div>
